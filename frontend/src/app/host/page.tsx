...
export default function HostPage() {
  ...
  const [days, setDays] = useState<Day[]>([{ date: '', events: [{ name: '', time: '', venue: '' }] }]);
  ...
  // Post-save state
  const [savedWeddingId, setSavedWeddingId] = useState<string | null>(null);
  ...
  const updateEvent = (dayIndex: number, eventIndex: number, field: keyof Event, value: string) => {
    const newDays = [...days];
